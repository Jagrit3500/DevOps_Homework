...
![Container networking](container-networking/container-networking_24bcs10642.png)

## Host Network

Apache uses the host network and is available on port `80`.

![Host-network container](host-network/host-network-started_24bcs10642.png)

![Apache on port 80](host-network/host-network-page_24bcs10642.png)
...
![Bind mount before update](bind-mount/bind-mount-before_24bcs10642.png)

![Bind mount after update](bind-mount/bind-mount-after_24bcs10642.png)
