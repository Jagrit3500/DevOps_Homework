...
![ClusterIP Service, endpoints, and internal client response](01-clusterip/clusterip-service_24bcs10642.png)
...
![NodePort Service and running Pods](02-nodeport/nodeport-service_24bcs10642.png)

![NGINX application reached through NodePort](02-nodeport/nodeport-browser_24bcs10642.png)
...
![LoadBalancer Service created with three running Pods](03-loadbalancer/loadbalancer-service_24bcs10642.png)

![NGINX application reached through the local LoadBalancer endpoint](03-loadbalancer/loadbalancer-browser_24bcs10642.png)

![LoadBalancer external IP assigned by Minikube tunnel](03-loadbalancer/loadbalancer-external-ip_24bcs10642.png)
...
![Response from the ExternalName target API](04-externalname/externalname-service_24bcs10642.png)
...
![Headless Service DNS results and direct Pod response](05-headless/headless-service_24bcs10642.png)
