...
def hello_world():
    ...
    <head>
      ...
      <style>
        ...
        h1 { color: #facc15; margin-bottom: 0.5rem; }
        p { color: #94a3b8; font-size: 1.1rem; }
        .badge { display: inline-block; background: #ca8a04; color: white; padding: 4px 12px; border-radius: 9999px; font-size: 0.85rem; font-weight: 600; margin-top: 1rem; }
      </style>
    </head>
    <body>
      <div class="card">
        ...
        <span class="badge">Python Flask App • Port 5000</span>
      </div>
    </body>
    </html>
    """
