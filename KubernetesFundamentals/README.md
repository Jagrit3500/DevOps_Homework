...
![Cluster version, node detail, and control plane Pods](01-cluster-architecture/cluster-nodes_24bcs10642.png)

Running `kubectl get pods -n kube-system` shows these components as real Pods
on the node.

![Cluster info and control plane Pods](01-cluster-architecture/control-plane-pods_24bcs10642.png)
...
![Pod listing and describe output](02-kubectl-basics/kubectl-describe_24bcs10642.png)

![Pod logs showing the NGINX access line](02-kubectl-basics/kubectl-logs_24bcs10642.png)
...
![Interactive shell inside the container](02-kubectl-basics/kubectl-exec_24bcs10642.png)

`port-forward` tunnels a local port to the Pod, which is useful before any
Service exists.

![Port-forward listening on port 8080](02-kubectl-basics/port-forward_24bcs10642.png)

![The NGINX page returned through the forwarded port](02-kubectl-basics/port-forward-curl_24bcs10642.png)
...
![The same Deployment name in both namespaces](03-namespaces/namespace-isolation_24bcs10642.png)
...
![Cross-namespace DNS responses](03-namespaces/namespace-dns_24bcs10642.png)
