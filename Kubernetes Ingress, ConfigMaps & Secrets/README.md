...
image.
![Configmap Evidence](cofigmap/configmap_24bcs10642.png)
...
![Secret Evidence](secret/secret_24bcs10642.png)
...
the request.
![Ingress Evidence](ingress/ingress_24bcs10642.png)
...
![Frontend and backend responses through Ingress](full-demo/ingress-routes_24bcs10642.png)

The frontend is available at `yatri.local/` through the Ingress rule.

![Frontend route through Ingress](full-demo/ingress-frontend_24bcs10642.png)

The `/api/` route reaches the backend and confirms the injected configuration
and database username and name.

![Backend API route through Ingress](full-demo/ingress-backend_24bcs10642.png)
